...
class CriminalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validation->fails()){
            ...
            $criminal->region_id_1 = request('birth_region_id');
            $criminal->town_id_1 = request('birth_town_id');
            $criminal->city_id_1 = request('birth_city_id');
            $criminal->district = request('birth_district');
            $criminal->region_id_2 = request('current_region_id');
            $criminal->town_id_2 = request('current_town_id');
            $criminal->city_id_2 = request('current_city_id');
            $criminal->currentdistrict = request('current_district');
            ...
            $criminal->photo = request('religion_id');
            $criminal->Closest_respondent = request('Closest_respondent');
            $criminal->region_id_3 = request('Closest_respondent_region_id');
            $criminal->town_id_3 = request('Closest_respondent_town_id');
            $criminal->city_id_3 = request('Closest_respondent_city_id');
            ...
            $criminal->crime_description = request('crime_id');
            $criminal->criminal_type_id = request('crime_description');
            $criminal->crime_type_id = request('criminal_type_id');
            $criminal->arrest_court = request('arrest_court_id');
            ...
            $criminal->verdict_court = request('verdict_court_id');
            $criminal->updated_verdict_court = request('updated_verdict_court_id');
            // $criminal->court_id = request('court_id');
