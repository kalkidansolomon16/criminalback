...
class PrisionerApperanceController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        $validation = Validator::make($request->all(), [
            ...
            'hair_type_id' => 'required|exists:hair_types,id',
            'height' => 'required|numeric|min:50|max:300',
            'face' => 'required|string|max:255',
            'forehead' => 'required|string|max:255',
            'nose' => 'required|string|max:255',
            'eye_color' => 'required|string|max:100',
            'teeth' => 'required|string|max:255',
            'lip' => 'required|string|max:255',
            'ear' => 'required|string|max:255',
            'unique_appearance' => 'required|string|max:1000',
